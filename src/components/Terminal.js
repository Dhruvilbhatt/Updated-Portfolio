...
function Terminal({ setButtonVisible }) {
  ...
  const aboutCommand = () => {
    ...
    pointSix.innerHTML =
      "* Web/Compute Stack: C/C++, Java, Python, HTML, CSS, JavaScript, Typescript, React.js, Next.js, Node.js, Express, SQL, MongoDB, GraphQL, HTML, CSS, TailwindCSS, Git";
  ...
  const educationCommand = () => {
    ...
    pointOneSpan.innerHTML =
      "University of California, Irvine (USA) (09/2022 - 12/2023)";
    ...
    pointOneULLI_1.innerHTML =
      "Relevant Coursework: Advanced Programming, Machine Learning, Operating Systems, Algorithm, Parallel and Distributed Computing";
    ...
    pointTwoULLI_1.innerHTML =
      "Relevant Coursework: High Performance Computing, Object-Oriented Programming, Computer Architecture, Computer Networks, Database Management, Data Structure, Algorithms, Software Engineering";
  ...
  const experienceCommand = () => {
    ...
    var pointFiveSpan = document.createElement("span");
    pointFiveSpan.style.color = "#66C2CD";
    pointFiveSpan.innerHTML =
      "Institute for Plasma Research (Ahmedabad, India)";
    pointFive.appendChild(pointFiveSpan);
    pointFive.innerHTML +=
      " - High Performance and Parallel Computing Researcher";
  ...
  const publicationsCommand = () => {
    ...
    pointTwoATag.setAttribute(
      "href",
      "https://onlinelibrary.wiley.com/doi/10.1002/cpe.7217"
    );
    ...
    pointThreeATag.setAttribute(
      "href",
      "https://link.springer.com/chapter/10.1007/978-981-99-3080-7_13"
    );
  ...
  const projectsCommand = () => {
    ...
    pointOne.appendChild(pointOneSpan);
    pointOne.innerHTML +=
      " with features like auto text correction, paraphrasing, summarization, and collaboration. Used WebRTC to integrate video calling with low latency and screen-sharing. Deployed Flask-based AI model on AWS EC2 for scalability. Designed RESTful APIs for seamless frontend-backend communication with MongoDB for fast page load times.";
    ...
    var pointThreeSpan = document.createElement("span");
    pointThreeSpan.style.color = "#66C2CD";
    pointThreeSpan.innerHTML =
      "unique features and establish interrelatedness between these cuisines";
    pointThree.appendChild(pointThreeSpan);
    pointThree.innerHTML +=
      " using the FP-Growth Algorithm. Created three dendrograms with distinct distance metrics to visualize the hierarchical clustering of these cuisines.";
    ...
    var pointFourSpan = document.createElement("span");
    pointFourSpan.style.color = "#66C2CD";
    pointFourSpan.innerHTML =
      "live chat web platform synchronized with Google accounts";
    pointFour.appendChild(pointFourSpan);
    pointFour.innerHTML +=
      ", facilitating multiple conversations. Employed WebSockets and Node.js for instant communication. Utilized Material UI and React to craft the frontend. Managed user authentication and data storage through MongoDB.";
  ...
  const teachingCommand = () => {
    ...
    pointOneSpan.style.color = "#66C2CD";
    pointOneSpan.innerHTML =
      "University of California, Irvine (USA) (09/2023 - 12/2023)";
    var pointOneUL = document.createElement("ul");
    var pointOneULLI_1 = document.createElement("li");
    pointOneULLI_1.innerHTML =
      "Teaching Assistant for MSWE (Master of Software Engineering) 245P (GUI Programming), and MSWE 250P (Web Programming).";
    var pointOneULLI_2 = document.createElement("li");
    pointOneULLI_2.innerHTML =
      "MSWE 245P explores interactive software with graphical user interfaces, covering GUI programming libraries/frameworks, layout design, and event-driven programming.";
    var pointOneULLI_3 = document.createElement("li");
    pointOneULLI_3.innerHTML =
      "MSWE 245P covers GUI programming libraries, layout design, and event-driven programming for interactive software with graphical user interfaces.";
    pointOneUL.appendChild(pointOneULLI_1);
    ...
    var pointTwoSpan = document.createElement("span");
    pointTwoSpan.style.color = "#66C2CD";
    pointTwoSpan.innerHTML =
      "University of California, Irvine (USA) (04/2023 - 06/2023)";
    var pointTwoUL = document.createElement("ul");
    var pointTwoULLI_1 = document.createElement("li");
    pointTwoULLI_1.innerHTML =
      "Teaching Assistant for MSWE (Master of Software Engineering) 245P (GUI Programming), and MSWE 250P (Web Programming).";
    var pointTwoULLI_2 = document.createElement("li");
    pointTwoULLI_2.innerHTML =
      "Introductory statistical techniques for collecting and analyzing experimental and observational data in health sciences and biology. Topics include data exploration, probability, sampling distributions, statistical inference, linear regression, and analysis of variance.";
    var pointTwoULLI_3 = document.createElement("li");
    pointTwoULLI_3.innerHTML =
      "MSWE 245P covers GUI programming libraries, layout design, and event-driven programming for interactive software with graphical user interfaces.";
    pointTwoUL.appendChild(pointTwoULLI_1);
    ...
    pointThreeULLI_1.innerHTML =
      "Teaching Assistant for Computational Finance course, creating lab assignments and coding contests for MSc Data Science students at DA-IICT.";
  ...
  return (
    <div id="terminal-base-class" className="terminal-base-class">
      ...
      <div className="terminal-shell-class" id="terminal-shell-class">
        ...
        <div className="start-terminal-class">
          Starting the server <span>.</span>
          <span>.</span>
          <span>.</span>
        </div>
