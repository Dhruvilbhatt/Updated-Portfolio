            ...
            <ul className='tiles-ul' id="list">
                ...
                <li class="leaf">
                    <div className='leaf-flex'>
                        ...
                        <p className='line-wrap-section' style={{ alignItems: 'end', marginTop: '25px' }}>
                            Master, CS
                        </p>
                    </div>
                </li>
                ...
                <li class="leaf">
                    <div className='leaf-flex'>
                        <p className='line-wrap-section' style={{ alignItems: 'start' }}>
                            Percussionist <span style={{ fontSize: 'larger', marginLeft: '2px' }}> 🥁</span>
                        </p>
                        <p className='line-wrap-section' style={{ alignItems: 'end', marginTop: '25px' }}>
                            Drums, Cajon
                        </p>
                ...
                <li class="leaf">
                    ...
                    <img src={tech} style={{ width: '96%', borderRadius: '5px', verticalAlign: 'middle' }} />
                    {/* <img src={AWS} style={{ width: '30%', borderRadius: '50%' }} /> */}
                </li>
                <li class="leaf">
                    <img style={{ width: '70%', borderRadius: '5px', verticalAlign: 'middle' }} src={LC} />
                </li>
